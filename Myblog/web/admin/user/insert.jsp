...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
         <span class="layui-breadcrumb" lay-separator="/">
              ...
              <a href="${pageContext.request.contextPath}/adminUser?command=index">用户列表</a>
              <a><cite>添加用户</cite></a>
        </span>
    </blockquote>
    <br><br>
    <form class="layui-form" action="${pageContext.request.contextPath}/adminUser?command=upFile" enctype="multipart/form-data" id="userForm"
          method="post">
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img" src="" id="caretakerAvatar" width="100"
                             height="100">
                        <p id="demoText"></p>
                    </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">出生年月日 <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">身份证 <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-inline">
