...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="myForm" action="${pageContext.request.contextPath}/adminArticle?command=edit&articleCode=${article.articleCode}">
        <input type="hidden" name="articleId" value="${article.articleCode}">
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img"  id="demo1" width="100" src="${pageContext.request.contextPath}/img/${article.articleThumbnail}"
                             height="100">
                        <p id="demoText"></p>
                    </div>
                </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="articleStatus" value="1" title="可发布"
                       <c:if test="${article.articleStatus==1}">checked</c:if>>
                <input type="radio" name="articleStatus" value="0" title="审核不通过"
